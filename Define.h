...
enum eArmor
{
	NORMAL_BULLET, SPREAD_BULLET, SUNFLOWER_BULLET, SCREW_BULLET, LEADING_BULLET
};
...
enum eObjID
{
	OBJ_PLAYER = 0, OBJ_MONSTER, OBJ_SPREAD_MONSTER,
	OBJ_BOSS_MONSTER, OBJ_MONSTER_BULLET, OBJ_BOSS_BULLET ,OBJ_PLAYER_BULLET, OBJ_END
};
